...
if (isset($_POST['insertWebDevBtn'])) {
	...
	$query = insertWebDev($pdo, $_POST['username'], $_POST['firstName'], 
		$_POST['lastName'], $_POST['dateOfBirth'], $_POST['country']);
...
if (isset($_POST['editWebDevBtn'])) {
	...
	$query = updateWebDev($pdo, $_POST['username'], $_POST['firstName'], $_POST['lastName'], 
		$_POST['dateOfBirth'], $_POST['country'], $_GET['web_dev_id']);
